...
namespace MagicOClockGenerator
{
    public partial class Form1 : Form
    {
        ...
        private string GetHeader(string title, bool isIndex)
        {
            ...
            string s = isIndex ? $@"
        .category_grid {{ display: grid; grid-template-columns: repeat(4, 90px); gap: 10px; justify-content: flex-start; margin-top: 10px; }}
...
.home-img {{ width: 160px; height: 36px; margin: 20px auto 0; display: block; background: rgba(255, 255, 255, 0.05); color: #FFF; border-radius: 10px; border: 1px solid rgba(255, 255, 255, 0.2); cursor: pointer; text-transform: uppercase; font-size: 12px; font-weight: 500; transition: all 0.3s; }}
